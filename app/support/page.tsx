         ...
         <div className="relative z-10 container-md px-6 py-24 min-h-screen flex flex-col items-center">
            ...
            >
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Contact Card */}
                  <div className="card-glass backdrop-blur-md bg-white/60 dark:bg-[#181818]/60 border border-white/20 dark:border-white/10 p-8 rounded-xl shadow-lg hover:border-primary/50 transition-colors group">
