...
export default function SettingsPage() {
  ...
  return (
    <div className="layout-container bg-gradient-to-br from-blue-100 via-blue-50 to-sky-50/30 dark:bg-[#181818] dark:bg-none relative">
                    ...
                    {settingsCategories.map((category) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-start gap-3 px-4 py-3 rounded-lg text-left transition-colors ${activeTab === category.id
